...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://github.com/shanyux/leaf/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://github.com/shanyux/leaf/tree/master/chanrpc))
...
```
go get github.com/shanyux/leaf
```
...
import (
    "github.com/shanyux/leaf/network"
)
...
import (
    "github.com/shanyux/leaf/network/json"
)
...
More references are at [leaf/go](https://github.com/shanyux/leaf/blob/master/go)。
...
More references are at [leaf/timer](https://github.com/shanyux/leaf/blob/master/timer)。
...
More references are at [leaf/log](https://github.com/shanyux/leaf/blob/master/log).

### Leaf recordfile

Leaf recordfile is formatted in CSV([Example](https://github.com/shanyux/leaf/blob/master/recordfile/test.txt)). recordfile is to manage the configuration for game. The usage of recordfile in LeafServer is quite simple:
...
Refer to [leaf/recordfile](https://github.com/shanyux/leaf/blob/master/recordfile) for more details.

Learn more
----------

More references are at Wiki [https://github.com/shanyux/leaf/wiki](https://github.com/shanyux/leaf/wiki)
